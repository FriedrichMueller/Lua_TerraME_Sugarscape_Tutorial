--Sugarscape-Migration rule 2 by Friedrich Müller
--Example of initially distributed agents in the southeast corner within a one unit per time step sugar regrowth environment
...
--------------------------------------------------------------------------------- 
--one unit each time step sugar regrowth
