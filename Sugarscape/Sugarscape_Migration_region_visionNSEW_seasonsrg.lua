--Sugarscape-Migration rule 1 by Friedrich Müller

--Example of initially distributed agents in the southeastcorner within a one unit per time step sugar regrowth environment
